			...
			<div class="header_cont">
				...
				<ul class="util clear">
					<c:choose>
						...
						<li><span style="color:#2E9AFE">${session_username}님[${session_userid}] 환영합니다</span></li>
					...
					<li><a href="#" onclick="$('.popup_base').css('height',$(document).height());$('.sitemap_pop').show();">사이트맵</a></li>
					<li><select id="selectlanguage" name="" onchange="location.href=this.value">
						<option value="/">Korean</option>
						<option value="/homeEn">English</option>
					</select><li>
				</ul>	
				<nav>
				<ul class="gnb clear">
				
				<li><a href="#" class="openAll4">소개</a>

                        <div class="gnb_depth gnb_depth2_4">
                            <ul class="submenu_list">
                                <li><a href="/sample" style="font-size:14px;">개요</a></li>
                                <li><a href="/sample/slide" style="font-size:14px;">비전</a></li>
                            </ul>
                        </div>
					</li>
				
				<li><a href="#" class="openAll3">분야</a>

                        <div class="gnb_depth gnb_depth2_3">
                            <ul class="submenu_list">
                                <li><a href="/sample" style="font-size:14px;">분야1</a></li>
                                <li><a href="/sample/slide" style="font-size:14px;">분야2</a></li>
                            	<li><a href="/sample/slide" style="font-size:14px;">분야3</a></li>
                            </ul>
                        </div>
					</li>
					...
					<li><a href="/sample" class="openAll1">포트폴리오</a>
                        ...
                        <div class="gnb_depth gnb_depth2_1">
                            <ul class="submenu_list">
                                <li><a href="/sample" style="font-size:14px;">원페이지</a></li>
                                <li><a href="/sample/slide" style="font-size:14px;">슬라이드</a></li>
                            </ul>
                        </div>
					</li>
					<li><a href="/board/list" class="openAll2">고객센터</a>
				        <div class="gnb_depth gnb_depth2_2">
                            <ul class="submenu_list">
                               ...
                               <!--  <li><a href="/board/list?searchBoard=notice"  style="font-size:13px;">공지사항</a></li>
                                <li><a href="/board/list?searchBoard=gallery"  style="font-size:13px;">갤러리</a></li> -->
                            </ul>
                        </div>
					</li>
				</ul>

...
<script src="/resources/js/jquery.min.js2"></script>
<script src="/resources/js/jquery.cycle2.js"></script>
...
<body>
	...
	<div id="wrap">
		...
		<article class="slider">
			...
			<img src="/resources/images/s4.jpg" width="1400" height="300"alt="">
			...
			<section class="promotion-section">
				<div class="container">
					<ul class="promo-list">
						<li><a href="#" onclick="return false"> <img src="/resources/images/s2.jpg" alt="">
								<h3>Cake</h3>
								<p>휴먼 교육센터 디지털 컨버전스</a></li>
								<li><a href="#" onclick="return false"> <img src="/resources/images/b2.jpg" alt="">
								<h3>Pudding</h3>
								<p>휴먼 교육센터 디지털 컨버전스</a></li>
								<li><a href="#" onclick="return false"> <img src="/resources/images/s1.jpg" alt="">
								<h3>Tiramisu</h3>
								<p>휴먼 교육센터 디지털 컨버전스</a></li>
								<li><a href="#" onclick="return false"> <img src="/resources/images/b4.jpg" alt="">
								<h3>Muffin</h3>
								<p>휴먼 교육센터 디지털 컨버전스</a></li>
					</ul>
				</div>
...
<li>
<a href="#" onclick="return false" onclick="return false">
<div class="info">
<h3>작업1</h3>
<span>소스/작업1</span>
</div>
...
<img src="/resources/images/s2.jpg" alt="">
</a>
</li>
<li>
<a href="#" onclick="return false">
...
<section class="blog-section">
			<div class="container">
				...
				<ul class="blog-list">
					<li><a href="#" onclick="return false"><img src="/resources/images/b5.jpg" alt=""></a>
						<time datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
					<li><a href="#" onclick="return false"><img src="/resources/images/s1.jpg" alt=""></a>
						<time datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
					<li><a href="#" onclick="return false"><img src="/resources/images/s2.jpg" alt=""></a>
						<time datetime="2016-10-30">OCT 30, 2016</time> <a href=""><h3>타임스페이스는
								사용자 중심의 웹페이지를 제작하는 회사 입니다.</h3></a></li>
				</ul>
			</div>
		...
		<section class="contact-section">
                <div class="container">
                    <h2 class="sec-tit" id="contactus">CONTACT US</h2>
                    <div class="form-box">
                        <form action="" method="">
...
allowfullscreen=""></iframe>
		<footer class="footer">
						<p class="copyright">&nbsp</p>
						<p>							<img src="/resources/images/logo.png"width="50" height="50">
						<a href="/">Icook </p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input class="form-control" id="message" placeholder="메세지내용을 입력해주세요">
      </div>

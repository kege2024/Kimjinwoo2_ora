...
public class HelloWorld {
	...
	public static void main(String[] args) {
		//페이지 시작 넘버 구하기
		int startBno = (1 - 1) * 10;
		System.out.println("(1page - 1) * perPageNum = " + startBno);
		startBno = (2 - 1) * 10;
		System.out.println("(2page - 1) * perPageNum = " + startBno);
		startBno = (3 - 1) * 10;
		System.out.println("(3page - 1) * perPageNum = " + startBno);

		System.out.println("------------------------------------------");
		//ceil메서드 - 페이지 인덱스에서 보이는 범위
